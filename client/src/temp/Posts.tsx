...
import { PostType, PostTextType, PostMediaType } from "../types/PostType.type";

export const posts_data: (PostTextType | PostMediaType)[] = [
  {
    _id: '8130717ouabeovbua',
    createdBy: { email: 'gokebello@gmail.com', first_name: 'goke', last_name: 'bello' },
    date: new Date(),
  ...
  },
  {
    ...
    createdBy: { email: 'benjamin@gmail.com', first_name: 'benjamin', last_name: 'udor' },
    date: new Date(),
  ...
  {
    _id: '914740274;akdac',
    createdBy: { email: 'anita@gmail.com', first_name: 'anita', last_name: 'ogaba' },
    date: new Date(),
    text: "Some quick example text to build on the card title and make up the bulk of the card's content.",
    type: PostType.TEXT,
    likes: 2000,
  ...
  },
  {
    ...
    createdBy: { email: 'joy@gmail.com', first_name: 'joy', last_name: 'ogbor' },
    date: new Date(),
  ...
  },
  {
    ...
    createdBy: { email: 'glory@gmail.com', first_name: 'glory', last_name: 'bello' },
    date: new Date(),
